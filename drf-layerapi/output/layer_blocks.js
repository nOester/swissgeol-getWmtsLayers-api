// Auto-generierte Layer-Konfiguration
        {
          ...
          label: t('lyr_Schweregrundnetz_label'),
        ...
        },
        {
          ...
          type: LayerType.swisstopoWMTS,
          label: t('lyr_Isostatische Anomalien 500_label'),
        ...
        },
        {
          ...
          type: LayerType.swisstopoWMTS,
          label: t('lyr_Bouguer-Anomalien 500_label'),
        ...
        },
        {
          ...
          type: LayerType.swisstopoWMTS,
          label: t('lyr_Gravimetrischer Atlas 100_label'),
        ...
        },
        {
          ...
          type: LayerType.swisstopoWMTS,
          label: t('lyr_Gravimetrische Messpunkte 100_label'),
        ...
        },
        {
          ...
          type: LayerType.swisstopoWMTS,
          label: t('lyr_Geoidmodell in CH1903_label'),
